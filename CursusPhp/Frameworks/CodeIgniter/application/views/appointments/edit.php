<div class="row">
    <div class="col-lg-6">
        ...
        <div class="well">
            <form method="POST" action="<?= base_url() ?>appointments/edit/<?= $appointment->appointmentid ?>" role="form" class="form-horizontal">
                <div class="form-group">
                    <label for="date" class="col-lg-2 control-label">Datum</label>
                    <div class="col-lg-10">
                        <input type="date" class="form-control" id="date" name="date" 
                               placeholder="Datum afspraak" maxlength="32" value="<?= set_value('date', $appointment->date); ?>" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="time" class="form-control" id="start" name="start" 
                               placeholder="Startuur afspraak" maxlength="32" value="<?= set_value('start', $appointment->start); ?>" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="time" class="form-control" id="end" name="end" 
                               placeholder="Einduur afspraak" maxlength="32" value="<?= set_value('end', $appointment->end); ?>" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <textarea class="form-control" id="description" name="description" 
                                  placeholder="Beschrijving afspraak" maxlength="128" required><?= set_value('description', $appointment->description); ?></textarea>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="location" name="location" 
                               placeholder="Locatie afspraak" maxlength="32" value="<?= set_value('location', $appointment->location); ?>" required />
                    </div>
                    <div class="col-lg-6">
                ...
                <tbody>
                    <?php foreach ($slots as $slot) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url() ?>appointments/deletetimeslot/<?= $appointment->appointmentid ?>/<?= $slot->appointmentslotid ?>">
...
<p><a href="<?= base_url() ?>appointments/detail/<?= $appointment->appointmentid ?>" class="btn btn-default">Terug</a></p>
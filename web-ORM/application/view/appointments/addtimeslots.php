        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="time" class="form-control" id="start" name="start" 
                       placeholder="Startuur tijdsloten" maxlength="5" value="<?= $this->_form->set_value('start'); ?>" required>
            </div>
            <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="time" class="form-control" id="end" name="end" 
                       placeholder="Einduur tijdsloten" maxlength="5" value="<?= $this->_form->set_value('end'); ?>" required>
            </div>
            <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="time" class="form-control" id="interval" name="interval" 
                       placeholder="Lengte tijdsloten (bv 15 minuten)" maxlength="5" value="<?= $this->_form->set_value('interval'); ?>" required>
            </div>
            <div class="col-lg-6">
                <?= $this->_form->form_error('interval', '<span class="text-danger">', '</span>'); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                <button type="submit" name="submit" class="btn btn-primary">Voeg tijdsloten toe</button> 
                <a href="<?= RouteHelper::base_url() ?>appointments/detail/<?= $this->appointment->appointmentid; ?>" class="btn btn-default">Annuleer</a>
            </div>
        </div>
    </form>
</div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" id="firstname" name="firstname" 
                           placeholder="Voornaam" maxlength="32" value="<?= $this->_form->set_value('firstname'); ?>" required>
                </div>
                <div class="col-lg-6">
                    <?= $this->_form->form_error('firstname', '<span class="text-danger">', '</span>'); ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" id="lastname" name="lastname" 
                           placeholder="Familienaam" maxlength="32" value="<?= $this->_form->set_value('lastname'); ?>" required>
                </div>
                <div class="col-lg-6">
                    <?= $this->_form->form_error('lastname', '<span class="text-danger">', '</span>'); ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="password" class="form-control" id="passwordConfirm" name="passwordConfirm" 
                           placeholder="Herhaal paswoord" maxlength="128" value="<?= $this->_form->set_value('passwordConfirm'); ?>" required>
                </div>
                <div class="col-lg-6">
                    <?= $this->_form->form_error('passwordConfirm', '<span class="text-danger">', '</span>'); ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="email" class="form-control" id="email" name="email" 
                           placeholder="Email adres" maxlength="128" value="<?= $this->_form->set_value('email'); ?>" required>
                </div>
                <div class="col-lg-6">
                    <?= $this->_form->form_error('email', '<span class="text-danger">', '</span>'); ?>
                </div>
            </div>
            <div class="form-group">

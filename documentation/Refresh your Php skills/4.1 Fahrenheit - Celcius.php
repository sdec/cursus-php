        ...
        <div class="container">
            <div class="jumbotron">
				...
				<p> <?php
					...
					highlight_file_with_line_numbers('4.1 Fahrenheit - Celciusb.php');
				?> <a href="4.1 Fahrenheit - CelciusDemo.php" class="btn btn-primary">Demo</a></p>
                
                <p>
                    <a href="#" class="btn btn-primary">Vorige Les</a>
					<a href="4.1 Fahrenheit - Celciuss.php" class="btn btn-primary">Oplossing</a> 
